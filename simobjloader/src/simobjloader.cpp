...
void SimObject::setObjectPosition() {

    positionX = positionX0;
    positionY = positionY0;
    positionZ = positionZ0;
}
...
SimBox::SimBox(double posx0, double posy0, double posz0,
...
SimSph::SimSph(double posx0, double posy0, double posz0,
               double posx,  double posy,  double posz,
               double rotx,  double roty,  double rotz,
               double red,   double green, double blue,
               double rad) {
...
SimSSph::SimSSph(double posx0, double posy0, double posz0,
                 double posx,  double posy,  double posz,
                 double rotx,  double roty,  double rotz,
                 double red,   double green, double blue,
                 double rad) {
...
SimCyl::SimCyl(double posx0, double posy0, double posz0,
               double posx,  double posy,  double posz,
               double rotx,  double roty,  double rotz,
               double red,   double green, double blue,
...
SimSCyl::SimSCyl(double posx0, double posy0, double posz0,
                 double posx,  double posy,  double posz,
                 double rotx,  double roty,  double rotz,
                 double red,   double green, double blue,
                 double rad,   double hei) {
...
SimModel::SimModel(double posx0, double posy0, double posz0,
                   double posx,  double posy,  double posz,
                   double rotx,  double roty,  double rotz,
...
SimSModel::SimSModel(double posx0, double posy0, double posz0,
                     double posx,  double posy,  double posz,
                     double rotx,  double roty,  double rotz,
                     ConstString mes, ConstString tex) {
