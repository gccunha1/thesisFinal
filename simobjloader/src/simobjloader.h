...
public:
    SimBox(double posx0, double posy0, double posz0,
...
public:
    SimSBox(double posx0, double posy0, double posz0,
            double posx,  double posy,  double posz,
            double rotx,  double roty,  double rotz,
            double red,   double green, double blue,
            double sizx,  double sizy,  double sizz);
...
public:
    SimSph(double posx0, double posy0, double posz0,
           double posx,  double posy,  double posz,
           double rotx,  double roty,  double rotz,
           double red,   double green, double blue,
           double rad);
...
public:
    SimSSph(double posx0, double posy0, double posz0,
            double posx,  double posy,  double posz,
            double rotx,  double roty,  double rotz,
            double red,   double green, double blue,
            double rad);
...
public:
    SimCyl(double posx0, double posy0, double posz0,
           double posx,  double posy,  double posz,
           double rotx,  double roty,  double rotz,
           double red,   double green, double blue,
...
public:
    SimSCyl(double posx0, double posy0, double posz0,
            double posx,  double posy,  double posz,
            double rotx,  double roty,  double rotz,
            double red,   double green, double blue,
            double rad,   double hei);
...
public:
    SimModel(double posx0, double posy0, double posz0,
             double posx,  double posy,  double posz,
             double rotx,  double roty,  double rotz,
...
public:
    SimSModel(double posx0, double posy0, double posz0,
              double posx,  double posy,  double posz,
              double rotx,  double roty,  double rotz,
              ConstString mes, ConstString tex);
    virtual Bottle   makeObjectBottle(vector<int>& ind, bool collision = true);
